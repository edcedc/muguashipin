package com.yc.mugua.weight.buttonBar;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.zw01 : R.mipmap.zw01);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.zx01 : R.mipmap.zx01);
                break;
            case 2:
                mIcon.setImageResource(selected? R.mipmap.st01 : R.mipmap.st01);
                break;
            case 3:
                mIcon.setImageResource(selected? R.mipmap.wd01 : R.mipmap.wd01);
                break;
        }
        if (selected) {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.red_EF402C));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.red_EF402C));
        } else {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_gray));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.gray_C1C9D6));
        }
    }
